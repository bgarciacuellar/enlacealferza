                              ...
                              <tr style="border-collapse:collapse">
                                <td align="left" style="padding:0;Margin:0;padding-top:5px;padding-bottom:15px">
                                  <h2
                                    ...
                                    <strong>¡La nómina está lista! Ingrese a la plataforma para validarla.</strong>
                                  </h2>
                                </td>
                              </tr>
                              <tr style="border-collapse:collapse">
                                <td align="left" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px">
                                  <p
                                    ...
                                    Le informamos que el cálculo de nómina ha sido completado. Por favor, conéctese a la
                                    plataforma para validar los datos y continuar con el proceso.</p>
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:23px;color:#555555;font-size:15px">
                                    <br>
                                  </p>
                              ...
                              <tr style="border-collapse:collapse">
                                <td align="center" style="padding:30px;Margin:0"><span class="es-button-border"
                                    style="border-style:solid;border-color:#0d2754;background:#0d2754;border-width:0px;display:inline-block;border-radius:10px;width:auto"><a
                                      href="{{ route('employee.details', $ticket) }}" class="es-button es-button-1"
                              ...
                              <tr style="border-collapse:collapse">
                                <td align="left" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px">
                                  <p
                                    ...
                                    navegador web: {{ route('employee.details', $ticket) }}</p>
                                </td>
                              </tr>
                            </table>
                          </td>
                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" role="presentation"
                              ...
                              <tr style="border-collapse:collapse">
                                <td class="made_with" align="center" style="padding:10px;Margin:0;font-size:0px"><a
                                    target="_blank" href="https://enlacealferza.com/"
                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#666666;font-size:12px"><img
