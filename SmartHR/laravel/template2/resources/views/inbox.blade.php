                                    ...
                                    <ul>
                                        <li>
                                            <div class="add-emp-section">
                                                <a href="compose" class="btn btn-success btn-add-emp"><i class="fas fa-plus"></i> Compose</a>
                                            </div>
                                        </li>
                                        <li class="mt-4"> 
                                            <a href="inbox" class="active">Inbox <span class="mail-count">(21)</span></a>
                                        </li>
                                        <li> 
                                            <a href="#">Starred</a>
                                        </li>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-auto top-action-right">
                                                <div class="text-right">
                                                    <button type="button" title="Refresh" data-toggle="tooltip" class="btn btn-white d-none d-md-inline-block"><i class="fas fa-redo"></i></button>
                                                    <div class="btn-group">
