                    ...
                    <div class="tab-content">
                            ...
                            <div class="row filter-row mt-4">
                                ...
                                <div class="col-md-4">
                                    <div class="add-emp-section">
                                        <a href="#" class="btn btn-success btn-add-emp" data-toggle="modal" data-target="#add_addition"><i class="fas fa-plus"></i> Add Addition</a>
                                    </div>
                                </div>
                            </div>
                            <!-- /Add Addition Button -->
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-right ico-sec">
                                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#edit_addition"><i class="fas fa-pen"></i></a>
                                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_addition"><i class="far fa-trash-alt"></i></a>
                                                </td>
                                            </tr>
                                            <tr>
                        ...
                        <div class="tab-pane" id="tab_overtime">
                            ...
                            <div class="row filter-row mt-4">
                                ...
                                <div class="col-md-4">
                                    <div class="add-emp-section">
                                        <a href="#" class="btn btn-success btn-add-emp" data-toggle="modal" data-target="#add_overtime"><i class="fas fa-plus"></i> Add Overtime</a>
                                    </div>
                                </div>
                            </div>
                            <!-- /Add Overtime Button -->
                                    ...
                                    <table class="table table-hover table-radius">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>Hourly 1.5</td>
                                                <td class="text-right ico-sec">
                                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#edit_overtime"><i class="fas fa-pen"></i></a>
                                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_overtime"><i class="far fa-trash-alt"></i></a>
                                                </td>
                                            </tr>
                                            <tr>
                        ...
                        <div class="tab-pane" id="tab_deductions">
                            ...
                            <div class="row filter-row mt-4">
                                ...
                                <div class="col-md-4">
                                    <div class="add-emp-section">
                                        <a href="#" class="btn btn-success btn-add-emp" data-toggle="modal" data-target="#add_deduction"><i class="fas fa-plus"></i> Add Deduction</a>
                                    </div>
                                </div>
                            </div>
                            <!-- /Add Deductions Button -->
                                    ...
                                    <table class="table table-hover table-radius">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>$12</td>
                                                <td class="text-right ico-sec">
                                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#edit_deduction"><i class="fas fa-pen"></i></a>
                                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_deduction"><i class="far fa-trash-alt"></i></a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Advance</th>
