                    ...
                    <div class="row filter-row">
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="add-emp-section">
                                <a href="#" class="btn btn-success btn-add-emp" data-toggle="modal" data-target="#add_user"><i class="fas fa-plus"></i> Add User</a>
                            </div>
                        </div> 
                    </div>
                    <!-- Search Filter -->
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-right ico-sec">
                                                <a href="#" data-toggle="modal" data-target="#edit_user"><i class="fas fa-pen"></i></a>
                                                <a href="#" data-toggle="modal" data-target="#delete_user"><i class="far fa-trash-alt"></i></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
