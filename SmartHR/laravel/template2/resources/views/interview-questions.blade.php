                    ...
                    <div class="row filter-row">
                        ...
                        <div class="col-md-6 text-right">
                            <div class="add-emp-section">
                                <a href="#" class="btn btn-success btn-add-emp mr-3" data-toggle="modal" data-target="#add_question"><i class="fas fa-plus"></i> Add Question</a>
                                <a href="#" class="btn btn-success btn-add-emp" data-toggle="modal" data-target="#add_category"><i class="fas fa-plus"></i> Add Category</a>
                            </div>
                        </div>
                    </div>
                    <!-- /Search Filter -->
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-right ico-sec">
                                                <a href="#" data-toggle="modal" data-target="#edit_question"><i class="fas fa-pen"></i></a>
