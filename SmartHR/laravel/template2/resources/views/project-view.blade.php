                            ...
                            <div class="page-head-box">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Hospital Admin</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="row filter-row">
                        ...
                        <div class="col-md-6 text-right">
                            <div class="add-emp-section">
                                <a href="task-board" class="btn btn-success btn-add-emp btn-view-task mr-3"><i class="fas fa-tasks"></i> View Taskboard</a>
                                <a href="#" class="btn btn-success btn-add-emp" data-toggle="modal" data-target="#edit_project"><i class="fas fa-plus"></i> Create Project</a>
                            </div>
                        </div>
                    </div>
                    <!-- /Search Filter -->
