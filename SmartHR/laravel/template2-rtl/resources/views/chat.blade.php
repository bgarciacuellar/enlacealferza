                                ...
                                <div class="fixed-header">
                                    <div class="navbar">
                                        <div class="user-details ml-auto">
                                            <div class="float-right user-img">
                                        ...
                                        <ul class="nav custom-menu">
                                            ...
                                            <li class="nav-item">
                                                <a href="voice-call" class="nav-link"><i class="fas fa-phone-alt"></i></a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="video-call" class="nav-link"><i class="fas fa-video"></i></a>
                                            </li>
                                                    ...
                                                    <div class="table-content">
                                                        ...
                                                        <div class="chat-profile-info">
                                                            <ul class="user-det-list">
                                                                <li>
                                                                    <span>Username:</span>
                                                                    <span class="float-left text-muted">johndoe</span>
                                                                </li>
                                                                <li>
                                                                    <span>DOB:</span>
                                                                    <span class="float-left text-muted">24 July</span>
                                                                </li>
                                                                <li>
                                                                    <span>Email:</span>
                                                                    <span class="float-left text-muted">johndoe@example.com</span>
                                                                </li>
                                                                <li>
                                                                    <span>Phone:</span>
                                                                    <span class="float-left text-muted">9876543210</span>
                                                                </li>
                                                            </ul>
                                                        </div>
