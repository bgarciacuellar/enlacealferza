            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
                    ...
                    <div class="row filter-row">
                        ...
                        <div class="col-sm-6 col-md-2">
                            <a href="#" class="btn btn-success btn-add-emp w-100" data-toggle="modal" data-target="#add_expense">Add Expense</a>
                        </div> 
                    </div>
                    <!-- Search Filter -->
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-right ico-sec">
                                                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#edit_expense"><i class="fas fa-pen"></i></a>
                                                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_expense"><i class="far fa-trash-alt"></i></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
