                                            ...
                                            <div class="tab-pane active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                                ...
                                                <div class="form-group form-row">
                                                    ...
                                                    <div class="col-md-12 approval-option">
                                                        ...
                                                        <input id="radio-single1" class="ml-2 default_expense_approval" value="seq-approver" checked="" name="default_expense_approval" type="radio">Sequence Approval (Chain) <sup> <span class="badge info-badge"><i class="fa fa-info" aria-hidden="true"></i></span></sup>
                                                        </label>
                                                        <label class="radio-inline ml-2">
                                                        <input id="radio-multiple3" class="ml-2 default_expense_approval" value="sim-approver" name="default_expense_approval" type="radio">Simultaneous Approval <sup><span class="badge info-badge"><i class="fa fa-info" aria-hidden="true"></i></span></sup>
                                                        </label>
                                                    </div>
                                                </div>
