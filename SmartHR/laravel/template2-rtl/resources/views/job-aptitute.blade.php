                                    ...
                                    <div class="card-body pb-0">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 text-center m-b-30">
                                                <a href="questions" class="btn btn-primary btn-block submit-btn">Html</a>
                                            </div>
                                            <div class="col-md-6 text-center m-b-30">
                                                <a href="questions" class="btn btn-primary btn-block submit-btn">Css</a>
                                            </div>
                                            <div class="col-md-6 text-center m-b-30">
                                                <a href="questions" class="btn btn-primary btn-block submit-btn">Design</a>
                                            </div>
                                            <div class="col-md-6 text-center m-b-30">
                                                <a href="questions" class="btn btn-primary btn-block submit-btn">Javascript</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
