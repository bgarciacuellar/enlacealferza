                    ...
                    <div class="row filter-row">
                        ...
                        <div class="col-md-4">
                            <div class="add-emp-section">
                                <a href="#" class="btn btn-success btn-add-emp" data-toggle="modal" data-target="#add_job"><i class="fas fa-plus"></i> Add Job</a>
                            </div>
                        </div>
                    </div>
                    <!-- /Search Filter -->
                                ...
                                <table class="table table-striped custom-table mb-0 datatable">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="job-applicants" class="role-info role-bg-three">3 Candidates</a></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="job-applicants" class="role-info role-bg-three">2 Candidates</a></td>
                                            <td class="text-right ico-sec">
                                                <a href="#" data-toggle="modal" data-target="#edit_job"><i class="fas fa-pen"></i></a>
                                                <a href="#" data-toggle="modal" data-target="#delete_job"><i class="far fa-trash-alt"></i></a>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="job-applicants" class="role-info role-bg-three">1 Candidates</a></td>
                                            <td class="text-right ico-sec">
                                                <a href="#" data-toggle="modal" data-target="#edit_job"><i class="fas fa-pen"></i></a>
                                                <a href="#" data-toggle="modal" data-target="#delete_job"><i class="far fa-trash-alt"></i></a>
                                            </td>
