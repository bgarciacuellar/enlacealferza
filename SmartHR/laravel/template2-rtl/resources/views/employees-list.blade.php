                    ...
                    <div class="row filter-row">
                        ...
                        <div class="col-md-4">
                            <div class="add-emp-section">
                                <a href="employees" class="grid-icon"><i class="fas fa-th"></i></a>
                                <a href="employees-list" class="list-icon active"><i class="fas fa-bars"></i></a>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-right ico-sec">
                                                <a href="#" data-toggle="modal" data-target="#edit_employee"><i class="fas fa-pen"></i></a>
