                            ...
                            <div class="page-head-box">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Aptitude</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                            ...
                                            <div style="display:none;" class="navbar">
                                                <div class="navbar-inner">
                                                    <ul class="nav nav-pills">
                                                        ...
                                                        <li class=""><a href="#step2" data-toggle="tab" data-step="2">Step 2</a></li>
                                                        <li class=""><a href="#step3" data-toggle="tab" data-step="3">Step 3</a></li>
                                                        <li class=""><a href="#step4" data-toggle="tab" data-step="4">Step 4</a></li>
                                                        <li class=""><a href="#step5" data-toggle="tab" data-step="5">Step 5</a></li>
                                                        <li class=""><a href="#step6" data-toggle="tab" data-step="6">Step 6</a></li>
                                                        <li class=""><a href="#step7" data-toggle="tab" data-step="7">Step 7</a></li>
                                                        <li class=""><a href="#step8" data-toggle="tab" data-step="8">Step 8</a></li>
                                                        <li class=""><a href="#step9" data-toggle="tab" data-step="9">Step 9</a></li>
                                                        <li class=""><a href="#step10" data-toggle="tab" data-step="10">Step 10</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="tab-pane fade in " id="step10">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <button class="btn btn-success btn-lg submit-btn mt-3" data-toggle="modal" data-target="#free_question_modal" type="button">Finish</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
